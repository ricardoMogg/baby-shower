        ...
        <div className="row" >
          ...
          <ul>
            ...
            <li>
              ...
              <button type="button" className="btn btn-sm btn-primary" onClick={()=>{showImg("img/mesa-1.png")}}>
                Ver imagen
              </button>
            </li>
            <li>
            Casi hasta abajo dice "Introduce un código postal en EE UU". Da click y usa el codigo postal <b style={{"fontSize":"20px"}}>98106</b> 
             <button type="button" className="btn btn-sm btn-primary" onClick={()=>{showImg("img/mesa-2.png")}}>
             Ver imagen
              </button>
            </li>
